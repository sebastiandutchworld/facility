odoo.define('dws_dae_recruitment.FieldResumeDWS', function (require) {
"use strict";
...
var AbstractGroupedOne2ManyRenderer2 = ListRenderer.extend({
    /**
...
var ResumeLineRenderer2 = AbstractGroupedOne2ManyRenderer2.extend({
    ...
    _formatData: function (data) {
        ...
        var date_start = (data.date_start && data.line_type_id.data.display_name != "Education") && data.date_start.format(dateFormat) || "Graduated On";
...
var FieldResume2 = FieldOne2Many.extend({
    ...
    _getRenderer: function () {
        return ResumeLineRenderer2;
    },
});

field_registry.add('hr_resume_dws', FieldResume2);
