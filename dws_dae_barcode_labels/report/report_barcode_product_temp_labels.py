...
class DynamicBarcodeProductTemplateLabelsParser(models.AbstractModel):
	_name = 'report.dws_dae_barcode_labels.product_temp_barcode_labels'
	...
	def _get_report_values(self, docids, data=None):
		barcode_labels_report = self.env['ir.actions.report']._get_report_from_name('dws_dae_barcode_labels.product_temp_barcode_labels')
