...
class MailMessage(models.Model):
    ...
    def unlink_rights_check(self):
        ...
        # Can delete messages?
        if not self.env.user.has_group("dws_mail_messages.group_delete"):
            raise AccessError(_("You cannot delete messages!"))

        # Can delete any message?
        if self.env.user.has_group("dws_mail_messages.group_delete_any"):
            return True
    ...
    def reply_prep_context(self):
        ...
        ctx = {
            ...
            # sets author_allowed_id (author_id) as default follower
